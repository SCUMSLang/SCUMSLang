...
namespace SCUMSLang.CommandLine
{
    ...
    {
        [Option("system-sources", HelpText = "Path(s) for system source file(s). If unset it is: " + CompilerParameters.RelativeUMSLFilesIndexPath)]
        ...
        [Option("implicit-int-pool-source", SetName = "implicit-int-pool", HelpText = "Path for source file that defines the implicit UInt32-pool. If unset it is:" + CompilerParameters.RelativeUMSLFilesUInt32PoolPath)]
